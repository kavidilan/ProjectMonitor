...
export default function App() {
  ...
  // All configured portal roles can edit/save data.
  const isVO = false;
  const vis = projects;
            ...
            <div className="cnt">
                ...
                <div style={{ padding: '24px', height: '100%', display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div style={{ flex: 1, display: 'flex', overflowY: 'auto' }}>
                    <ProjectSummaryPanel 
                      ...
                      onClose={() => setView('projectList')} 
                      onSave={(updatedProj) => { handleSaveModal(updatedProj); setView('projectList'); }}
                      isVO={isVO}
                      fullPage={true}
                    />
                  </div>
              ...
              {view === 'table'         && (
                <DataEntryTable
                  ...
                  reloadProjects={reloadProjects} // Added this prop to refresh data after upload
                />
              )}
            </div>
