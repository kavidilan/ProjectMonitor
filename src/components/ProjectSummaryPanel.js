...
const ProjectSummaryPanel = ({ project, onClose, onSave, isVO }) => {
    ...
    <>
      ...
      <motion.div
        ...
        style={{
          ...
          background: 'linear-gradient(160deg, rgba(10,18,38,0.97) 0%, rgba(15,28,52,0.98) 100%)',
          borderRadius: 16,
          border: `1px solid ${color}30`,
          boxShadow: `0 28px 64px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.06), 0 0 0 1px ${color}10`,
        ...
        <div style={{ padding: '16px 18px 0', flexShrink: 0 }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 14 }}>
            ...
            <div style={{ display: 'flex', gap: 10, flexShrink: 0 }}>
              ...
              <ProgressRing value={fin}  size={64} stroke={5} color="#6366f1" label="Financial" />
            </div>
          ...
          <AnimatePresence mode="wait">
                  ...
                  <div style={{ background: 'rgba(99,102,241,0.07)', border: '1px solid rgba(99,102,241,0.18)',
                    ...
                    {proj.kpi && (
                      <div style={{ marginBottom: proj.output ? 8 : 0 }}>
                        ...
                        <div style={{ fontSize: 11.5, color: '#c7d2fe', fontWeight: 600 }}>{proj.kpi}</div>
                      </div>
                    )}
                    {proj.output && (
                      <div style={{ marginBottom: proj.outcome ? 8 : 0 }}>
                        ...
                        <div style={{ fontSize: 11, color: '#a5b4fc', fontWeight: 500 }}>{proj.output}</div>
                      </div>
                    )}
                    {proj.outcome && (
                      <div>
                        ...
                        <div style={{ fontSize: 11, color: '#93c5fd', fontWeight: 500 }}>{proj.outcome}</div>
                      </div>
                    )}
                  </div>
                )}
            ...
            {tab === 'media' && (
              <motion.div key="media"
                ...
                {!isVO && (
                  <motion.div
                    animate={{ borderColor: dragging ? '#6366f1' : 'rgba(99,102,241,0.25)', background: dragging ? 'rgba(99,102,241,0.12)' : 'rgba(99,102,241,0.04)' }}
                    style={{ border: '2px dashed rgba(99,102,241,0.25)', borderRadius: 12, padding: '16px 12px',
                  ...
                  >
                    <motion.div animate={{ y: dragging ? -4 : 0 }} style={{ fontSize: 28, marginBottom: 6 }}>📸</motion.div>
                    <div style={{ fontSize: 12, fontWeight: 700, color: '#a5b4fc', marginBottom: 3 }}>
        ...
        {!isVO && (
          <div style={{ padding: '12px 18px', borderTop: '1px solid rgba(255,255,255,0.06)', flexShrink: 0,
            ...
            <motion.button whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}
              ...
              style={{ padding: '7px 18px', background: 'linear-gradient(135deg, #6366f1, #4f46e5)',
                border: 'none', borderRadius: 8, fontSize: 12, fontWeight: 700, color: '#fff',
                cursor: 'pointer', boxShadow: '0 3px 12px rgba(99,102,241,0.35)' }}>
              Save & Close
            </motion.button>
          </div>
        )}
