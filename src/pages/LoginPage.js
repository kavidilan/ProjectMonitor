...
const CREDENTIALS = [
  ...
  { username: 'urban_controller', password: 'Urban#Ctrl2026',   role: 'DDG_URBAN', department: 'Urban Dev',  label: 'DDG Urban Development',  short: 'UD',  access: 'View Only' },
  ...
  { username: 'urban_east_cell',password: 'Urban#East2026',     role: 'DDG_URBAN', department: 'East Urban', label: 'DDG Urban East',         short: 'UD',  access: 'View Only' },
  { username: 'urban_west_cell',password: 'Urban#West2026',     role: 'DDG_URBAN', department: 'West Urban', label: 'DDG Urban West',         short: 'UD',  access: 'View Only' },
];
