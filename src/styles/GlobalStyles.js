  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .tbar-icon-btn:hover { border-color: var(--acc); color: var(--acc); background: rgba(99,102,241,0.05); }
      ...
      .fs:focus { border-color: var(--acc); box-shadow: 0 0 0 3px rgba(99,102,241,0.1); }
      ...
      .filter-search:focus { border-color: var(--acc); box-shadow: 0 0 0 3px rgba(99,102,241,0.1); }
      ...
      .bp:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(99,102,241,0.35); }
      ...
      .btn-primary:hover   { transform: translateY(-2px); box-shadow: 0 12px 26px rgba(99,102,241,0.35); }
      ...
      .btn-secondary:hover { border-color: var(--acc); background: rgba(99,102,241,0.04); }
      ...
      .pi:hover { border-color: var(--acc); box-shadow: 0 4px 12px rgba(99,102,241,0.1); }
      .pi.on {
